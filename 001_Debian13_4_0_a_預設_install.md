#001_Debian13_4_0_a_預設_install.md
...
#
# 20251106 更新使用 python 3.14.0
#
# 20260415 更新使用 Python 3.14.4
#
...
#
update-alternatives --install /usr/bin/python python /usr/local/bin/python3.14 2
